    ...
    <div className="container mx-auto px-4 py-12 md:py-20 relative">
      <div className="flex flex-col items-center text-center max-w-6xl mx-auto">
        ...
        <div className="relative w-full h-[300px] md:h-[400px] mb-8">
          <Image
            src="/assets/svg/suite/suite_header.svg"
        ...
        {/* Text Content */}
        <div className="space-y-6 max-w-5xl my-6">
          <h1 className="text-3xl md:text-6xl lg:text-6xl font-bold text-primary leading-tight">
