  ...
  return (
    ...
    <div className="container mx-auto px-4">
      ...
      <div className="grid md:grid-cols-3 gap-8 md:gap-12 max-w-6xl mx-auto mb-12">
        ...
        <div className="flex flex-col items-center text-center space-y-4">
          <div className="relative w-24 h-24 mb-4">
            <div className="absolute inset-0 bg-white rounded-2xl shadow-lg transform -rotate-6"></div>
            <div className="relative w-full h-full">
              <Image
                src="/assets/png/suite/hair-follicle-icon.png"
                alt="Hair follicle illustration"
                fill
        ...
        <div className="flex flex-col items-center text-center space-y-4">
          <div className="relative w-24 h-24 mb-4">
            <div className="absolute inset-0 bg-white rounded-2xl shadow-lg transform rotate-3"></div>
            <div className="relative w-full h-full">
              <Image
                src="/assets/png/suite/checkmark-icon.png"
        ...
        <div className="flex flex-col items-center text-center space-y-4">
          <div className="relative w-24 h-24 mb-4">
            ...
            <div className="relative w-full h-full">
              <Image
                src="/assets/png/suite/hair-strand-icon.png"
                alt="Hair strand with water drops"
                fill
                className="object-contain drop-shadow-xl"
              />
            </div>
      ...
      <div className="text-center space-y-8">
        ...
        <p className="text-secondary/60 text-sm max-w-4xl mx-auto italic">
