      ...
      <section className="max-w-6xl  mx-auto px-4 py-12 text-center">
        <div className="space-y-6">
          <h2 className="text-secondary text-2xl md:text-2xl font-medium leading-relaxed max-w-4xl mx-auto">
            QR678 Neo is a proprietary, first in class hair fall & hair regrowth
            therapy, which has revolutionised the treatment of hair fall in
            alopecia. This formulation has been named QR678® Neo inspired by the
            new generation ubiquitous presence of “Quick Response“ QR code.
          </h2>
