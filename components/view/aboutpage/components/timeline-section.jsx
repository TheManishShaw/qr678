...
const timelineData = [
  ...
  {
    year: <span className="whitespace-pre-line">
    2012
    <br />- 2016
  </span>,
    title: "The rigour",
    description:<div><p className="text-lg text-primary mb-6 leading-relaxed">
    In-clinic user trial of 1000 patients of both genders to test effectiveness and safety of the formulation.
  </p>
    ...
    <div className=" mx-auto bg-[#FAF4EE] py-20 px-4">
      ...
      >
        THE <span className="relative">
          ...
          <span className="absolute bottom-2 left-[-40px] w-full h-1  "><Image
